...
The pre-built package can be downloaded from the repository's releases here. After downloading the package, import it to your project via the Unity Editor *Assets -> Import Package -> Custom Package..*.
